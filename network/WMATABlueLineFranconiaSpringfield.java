 ...
 */
 ...
 public class WMATABlueLineFranconiaSpringfield extends Line {
    public WMATABlueLineFranconiaSpringfield(Network network) {
        ...
        this.addStation(network.stations.get("addison road"), 1.60);
        this.addStation(network.stations.get("capitol heights"), 0.92);
        this.addStation(network.stations.get("benning road"), 1.37);
        this.addStation(network.stations.get("stadium-armory"), 2.48);
        this.addStation(network.stations.get("potomac avenue"), 0.73);
        ...
        this.addStation(network.stations.get("reagan washington national airport"), 0.55);
        this.addStation(network.stations.get("potomac yard"), 1.48);
        this.addStation(network.stations.get("braddock road"), 1.00);
        this.addStation(network.stations.get("king street"), 0.54);
        this.addStation(network.stations.get("van dorn street"), 3.76);
