public class WMATARedLineShadyGrove extends Line {

    public WMATARedLineShadyGrove(Network network) {
        ...
        this.addStation(network.stations.get("grosvenor-strathmore"), 1.38);
        ...
        this.addStation(network.stations.get("woodley park"), 0.76);
        ...
        this.addStation(network.stations.get("gallery place"), 0.28);
        this.addStation(network.stations.get("judiciary sq"), 0.31);
        this.addStation(network.stations.get("union station"), 0.71);
        this.addStation(network.stations.get("noma-gallaudet u"), 0.66);
        this.addStation(network.stations.get("rhode island ave"), 1.07);
        this.addStation(network.stations.get("brookland-cua"), 0.86);
        ...
        this.reverse("red line glenmont -> shady grove");
