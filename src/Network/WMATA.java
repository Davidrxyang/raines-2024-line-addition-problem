...
public class WMATA {
    public ArrayList<Station> WMATAStations;
    public Network WMATA;

    public Line blueLineDowntownLargo;
    public Line blueLineFranconiaSpringfield;
    public Line orangeLineNewCarrollton;
    public Line orangeLineVienna;
    public Line silverLineDowntownLargo;
    public Line silverLineAshburn;
    public Line redLineGlenmont;
    public Line redLineShadyGrove;
    public Line yellowLineMtVernonSq;
    public Line yellowLineHuntington;
    public Line greenLineBranchAve;
    public Line greenLineGreenbelt;
